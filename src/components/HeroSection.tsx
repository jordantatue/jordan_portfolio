        ...
        <MotionWrapper>
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-sm backdrop-filter p-4 rounded-lg border border-purple-500/20 dark:border-purple-500/10 shadow-sm">
            <p className="text-muted-foreground pl-4 py-2 mb-4 relative">
              ...
              👋 Moi c’est Jordan Tatue — futur ingénieur en informatique, passionné de code, de data et de bonnes pratiques DevOps. À la croisée du développement Full Stack, de l’automatisation IT et de la data science, j’aime transformer les lignes de code en solutions concrètes, utiles et (soyons honnêtes) un peu stylées.
              <br /><br />
